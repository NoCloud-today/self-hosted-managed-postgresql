...
RUN mkdir -p /home/postgres && \
    chown ${BACKREST_USER}:${BACKREST_GROUP} /home/postgres && \
    mkdir -p /var/lib/postgresql/${PG_VERSION}/$PG_CLUSTER && \
    chown -R ${BACKREST_USER}:${BACKREST_GROUP} /var/lib/postgresql
